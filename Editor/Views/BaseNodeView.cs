...
namespace GraphProcessor
{
	...
	public class BaseNodeView : NodeView
	{
		...
		private Color initOutPortColor;
        private Color initInPortColor;
        ...
        public void Initialize(BaseGraphView owner, BaseNode node)
		{
            ...
            nodeTarget.onProcessed += OnNodeProcessed;
        }
		...
		void OnNodeProcessed()
		{
            ...
            foreach (var item in outputPortViews)
			{
				item.portColor = Color.red;
			
			}
            foreach (var item in inputPortViews)
            {
                item.portColor = Color.red;
            }
			RefreshPorts();
		...
		public void ResetNodeColor()
		{
            ...
            mainContainer.style.backgroundColor = nodeTarget.color;

            foreach (var item in outputPortViews)
            {
				item.portColor = item.defaultColor;
            }
            foreach (var item in inputPortViews)
            {
                item.portColor = item.defaultColor;
